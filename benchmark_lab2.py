...
def compare_results(single_results, multi_results):
    ...
    if speedup > 3:
        ...
        print(f"   ⚠️  Limited speedup. May be bottlenecked by CPU or I/O.")
    
    print()

def test_rate_limiting(host, port, requests_per_second, duration=5):
    """
    Test rate limiting by making requests rapidly.
...
def main():
    print("""
╔═══════════════════════════════════════════════════════════════════╗
║         Lab 2: Performance Testing & Comparison Tool              ║
╚═══════════════════════════════════════════════════════════════════╝
""")
    ...
    if test_type == 'comparison':
        ...
        print("=" * 70)
        print("\n⚠️  Make sure you're running the SINGLE-THREADED server:")
        ...
        # Test rate limiting
        print("⚠️  Make sure server is running with rate limiting:")
