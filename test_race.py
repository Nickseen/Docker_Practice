#!/usr/bin/env python3
"""
Simple and Clear Race Condition Test
Makes 100 requests to index.html and checks the counter
"""
...
def get_file_counter(filename):
    """Get counter for a file from root directory"""
    html = make_request('/')
    if not html:
        return None
    
    # Looking for pattern: <td><a href="/index.html"> index.html</a></td>...<span class="count">42</span>
...
""")
    ...
    print(f"⚠️  Strange: counter increased more than expected")
